...
dict_adps_for_cases = {
    "Nom": ["от", "до", "из", "без", "у", "для", "около", "вокруг", "после", "кроме"],
    "Dat": ["к", "по"],
    "Acc": ["в", "за", "про", "через"],
    "Ins": ["с", "за", "под", "над", "между"],
    "Loc": ["о", "об", "в", "во", "на", "при"],
    "Gen": ["из"]
}
            ...
            if new_word.head == word.head:
                if new_word.upos in ["NOUN", "PROPN", "PRON"]:
                    ...
                    if case == "Gen":
                        if contains_iz:
                            if new_word.deprel == "nmod":
                                return {"word": original_number, "type": "NOM", "case": "Loc", "gender": gend,
                                        "number": "Sing",
                                        "deprel": deprel}
                        if new_word.deprel == "parataxis":
                            return {"word": original_number, "type": "ADJ", "case": "Gen", "gender": gend,
                                    "number": "Sing",
                                    "deprel": deprel}
                        if new_word.deprel == "nmod":
                        ...
                        if new_word.deprel == "obl":
                            ...
                            #                 "deprel": deprel}
                            # else:
                            if numb == "Plur" and new_word.deprel != "root":
                                return {"word": original_number, "type": "NUM", "case": "Gen", "gender": gend,
                                        "number": "Sing",
                                        "deprel": deprel}
                            else:
